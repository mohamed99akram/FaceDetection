...
face_detector = joblib.load('hFeatures6/faceDetector2.joblib')
...
for j in [966]:
    ...
    for i in [80]: # number of classifiers
        ...
        img_path=f'/home/akram/Pictures/Screenshots/Screenshot from 2023-07-05 12-42-27.png'
        ...
        # plt.show()
        # # detect face
        _, region, _, time= face_detector.find_face(gray)
        if resized:
